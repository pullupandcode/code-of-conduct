# Pull Up and Code: Rules of the Road
(Our Code of Conduct)
...
This code of conduct applies to all of this community's spaces, including public channels, private channels and direct messages, both online and off. Anyone who violates this code of conduct may be sanctioned or expelled from these spaces at the discretion of the administrators. This is inclusive of the Pull Up and Code Twitch stream (also bound by the Terms of Service), the Pull Up and Code Discord channel, any code communities or Github repositories under the Pull Up and Code banner, and any and all future community spaces we hold. 
...
If you are being harassed by a member of our community, notice that someone else is being harassed, or have any other concerns, please contact the administrators via email at pullupandcode@hey.com. If the person who is harassing you is on the admin team, they will not be involved in handling or resolving the incident.

The admin team will respond to any complaint as promptly as possible we can. If you do not get a timely response (for example, if no admins are currently online) then please put your personal safety and well-being first, and consider logging out and/or contacting the admins by email at pullupandcode@hey.com.
